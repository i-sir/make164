...
HTML;
    ...
    public function get_index_html($type, $field, $fields_value, $i, $f)
    {
        ...
        if ($type == 'user_id') {
            ...
            $result       .= "<img src='{:cmf_get_asset_url($avatar)}' style='height:40px;'>" . "\n";
            $result       .= '</a>' . "\n";
...
EOF;
    ...
    public function indexViews($parm, $controllers, $fields, $table_result_name, $index_checkbox_js = '')
    {
        ...
        $this->assign("url_list", "{:url('index',['params'=>\$params,'pid'=>\$pid])}");
        $this->assign("url_add", "{:url('add',['params'=>\$params,'pid'=>\$pid])}");
