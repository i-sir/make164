 ...
 *     "controller_name"     =>"ShopCouponUser",
 ...
 *     "remark"              =>"优惠券领取记录",
 *     "author"              =>"",
 *     "create_time"         =>"2024-08-30 16:34:56",
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\ShopCouponUserController();
 * )
 */
...
class ShopCouponUserController extends AdminBaseController
{
...
//    }
    ...
    public function index()
    {
        ...
        //查询数据
        $result = $ShopCouponUserInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $ShopCouponUserInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $ShopCouponUserInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $ShopCouponUserInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $ShopCouponUserInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $ShopCouponUserInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $ShopCouponUserInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $ShopCouponUserInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $ShopCouponUserInit->get_list($where, $params);
