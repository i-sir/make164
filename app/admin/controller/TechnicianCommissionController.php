 ...
 *     "controller_name"     =>"TechnicianCommission",
 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\TechnicianCommissionController();
 * )
 */
...
class TechnicianCommissionController extends AdminBaseController
{
...
//    }
    ...
    {
        $TechnicianCommissionInit  = new \init\TechnicianCommissionInit();//技师佣金管理    (ps:InitController)
        $TechnicianCommissionModel = new \initmodel\TechnicianCommissionModel(); //技师佣金管理   (ps:InitModel)
        $params                    = $this->request->param();

        //查询条件
        $where = [];
        if ($params["keyword"]) $where[] = ["user_id|commission|min_amount|max_amount", "like", "%{$params["keyword"]}%"];
        ...
        //查询数据
        $result = $TechnicianCommissionInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $TechnicianCommissionInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $TechnicianCommissionInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $TechnicianCommissionInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $TechnicianCommissionInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $TechnicianCommissionInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $TechnicianCommissionInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $TechnicianCommissionInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $TechnicianCommissionInit->get_list($where, $params);
