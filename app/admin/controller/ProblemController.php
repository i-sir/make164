 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\ProblemController();
 * )
 */
...
//    }
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $ProblemInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $ProblemInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $ProblemInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $ProblemInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $ProblemInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $ProblemInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $ProblemInit->get_list($where, $params);
