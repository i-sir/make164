 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\ShopOrderSaveController();
 * )
 */
...
class ShopOrderSaveController extends AdminBaseController
{
...
//    }
    ...
    {
        $ShopOrderSaveInit  = new \init\ShopOrderSaveInit();//技师已约时间    (ps:InitController)
        $ShopOrderSaveModel = new \initmodel\ShopOrderSaveModel(); //技师已约时间   (ps:InitModel)
        $params             = $this->request->param();

        //查询条件
        $where = [];
        if ($params["keyword"]) $where[] = ["user_id|order_num", "like", "%{$params["keyword"]}%"];
        ...
        //查询数据
        $result = $ShopOrderSaveInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $ShopOrderSaveInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $ShopOrderSaveInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $ShopOrderSaveInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $ShopOrderSaveInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $ShopOrderSaveInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $ShopOrderSaveInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $ShopOrderSaveInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $ShopOrderSaveInit->get_list($where, $params);
